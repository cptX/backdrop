...
$base = array(
  ...
  0x80 => NULL, NULL, NULL, NULL, '', '', 'A', ';', 'E', 'I', 'I', NULL, 'O', NULL, 'Υ', 'O',
  0x90 => 'i', 'A', 'B', 'G', 'D', 'E', 'Z', 'I', 'Th', 'I', 'K', 'L', 'M', 'N', 'X', 'O',
  0xA0 => 'P', 'R', NULL, 'S', 'T', 'Y', 'F', 'X', 'Ps', 'O', 'I', 'Y', 'a', 'e', 'i', 'i',
  0xB0 => 'y', 'a', 'b', 'g', 'd', 'e', 'z', 'i', 'th', 'i', 'k', 'l', 'm', 'n', 'x', 'o',
  0xC0 => 'p', 'r', 's', 's', 't', 'y', 'f', 'x', 'ps', 'o', 'i', 'y', 'o', 'y', 'o', &,
  0xD0 => 'b', 'th', 'Y', 'Y', 'Y', 'phi', 'pi', '&', NULL, NULL, 'St', 'st', 'W', 'w', 'Q', 'q',
